...
include("instrumentation:openai-client-instrumentation:common")
include("instrumentation:openai-client-instrumentation:testing-common")
include("instrumentation:openai-client-instrumentation:instrumentation-0.13.0")
include("instrumentation:openai-client-instrumentation:instrumentation-latest")
