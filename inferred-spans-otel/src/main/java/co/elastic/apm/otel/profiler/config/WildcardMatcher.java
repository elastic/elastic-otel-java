...
/**
 * This matcher is used in for example to disable tracing for certain URLs. The advantage of this
 * class compared to alternatives is that {@linkplain #matches(CharSequence) matching} strings is
