...
class ChatTest {
  ...
  void chat() throws Exception {
    ...
    assertThat(testing.logRecords())
        ...
        .anySatisfy(
            log -> {
              OpenTelemetryAssertions.assertThat(log)
                  .hasAttributesSatisfying(
                      attr ->
                          OpenTelemetryAssertions.assertThat(attr)
  ...
  private ChatCompletionMessageParam createAssistantMessage(String content) {
  ...
  private ChatCompletionMessageParam createAssistantMessage(
      List<ChatCompletionMessageToolCall> toolCalls) {
    return ChatCompletionMessageParam.ofAssistant(
        ChatCompletionAssistantMessageParam.builder()
  ...
  private ChatCompletionMessageParam createUserMessage(String content) {
  ...
  private ChatCompletionMessageParam createSystemMessage(String content) {
  ...
  private ChatCompletionMessageParam createDeveloperMessage(String content) {
  ...
  private ChatCompletionMessageParam createToolMessage(String response, String id) {
