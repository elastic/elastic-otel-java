...
public class InstrumentedEmbeddingsService implements EmbeddingService {
            ...
            Instrumenter.<RequestHolder, CreateEmbeddingResponse>builder(
                    ...
                    .addAttributesExtractor(new AttributesExtractor<>() {
                        ...
                        public void onStart(AttributesBuilder attributes, Context parentContext, RequestHolder requestHolder) {
                            ...
                            request.encodingFormat().ifPresent(format -> attributes.put(GEN_AI_REQUEST_ENCODING_FORMATS, Collections.singletonList(format.toString())));
                        }

                        @Override
                        public void onEnd(AttributesBuilder attributes, Context context, RequestHolder requestHolder,
    ...
    @NotNull
    @Override
    public CreateEmbeddingResponse create(@NotNull EmbeddingCreateParams embeddingCreateParams, @NotNull RequestOptions requestOptions) {
