...
class ChatTest {
  ...
  private static void assertThatChoiceBodyHasNoContent(Value<?> body, String finishReason) {
    ValAssert.map()
        ...
        .accept("", body);
    Value<?> message = ((List<KeyValue>) body.getValue()).stream()
        .filter(kv -> kv.getKey().equals("message")).findFirst().get().getValue();
  ...
  void stream() throws Exception {
    ...
    try (StreamResponse<ChatCompletionChunk> result = openai.client.chat().completions()
  ...
  void toolsWithFollowupAndCaptureContent() {
    ...
    ChatCompletionMessageParam assistantMessage = ChatCompletionMessageParam.ofChatCompletionAssistantMessageParam(
        ...
        .function(FunctionDefinition.builder()
            ...
            .parameters(FunctionParameters.builder()
                ...
                .putAdditionalProperty("required",
                    JsonValue.from(Collections.singletonList("location")))
    ...
    return ChatCompletionTool.builder()
        ...
        .function(FunctionDefinition.builder()
            ...
            .parameters(FunctionParameters.builder()
                .putAdditionalProperty("type", JsonValue.from("object"))
                .putAdditionalProperty("required",
                    JsonValue.from(Collections.singletonList("order_id")))
                .putAdditionalProperty("additionalProperties", JsonValue.from(false))
                .putAdditionalProperty("properties", JsonObject.of(properties))
                .build())
            .build())
