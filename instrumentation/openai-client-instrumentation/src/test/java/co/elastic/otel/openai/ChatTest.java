...
class ChatTest {
    ...
    static Consumer<HistogramPointData> assertThatDurationIsLessThan(long toNanos) {
        ...
        return point ->
                assertThat(point.getSum()).isStrictlyBetween(0.0, toNanos / nanosPerSecond);
    }
    ...
    private static void assertThatChoiceBodyHasNoContent(Value<?> body, String finishReason) {
        ValAssert.map()
                ...
                .accept("", body);
        Value<?> message = ((List<KeyValue>) body.getValue()).stream().filter(kv -> kv.getKey().equals("message")).findFirst().get().getValue();
    ...
    void allTheClientOptions() {
        ...
        assertThat(result.choices().getFirst().message().content()).hasValue(content);
        ...
        assertThat(spans)
                ...
                .satisfies(span -> {
                    assertThat(span)
                            ...
                            .hasAttribute(GEN_AI_SYSTEM, "openai")
                            .hasAttribute(GEN_AI_RESPONSE_ID, "chatcmpl-Ag6GcK2pCxesrMMkpBCxcqrlSoU9z")
                            .hasAttribute(GEN_AI_RESPONSE_MODEL, TEST_CHAT_RESPONSE_MODEL)
                            .hasAttributesSatisfying(attribs -> {
                                assertThat(attribs.get(GEN_AI_RESPONSE_FINISH_REASONS))
                                        .containsExactly("stop");
    ...
    // TODO: JSON strings are currently asserted by value, so different spacing from different providers
    ...
    void toolCalls() {
        ...
        ChatCompletionCreateParams params = ChatCompletionCreateParams.builder()
                .messages(List.of(
                        createSystemMessage("You are a helpful customer support assistant. Use the supplied tools to assist the user."),
                        createUserMessage("Hi, can you tell me the delivery date for my order?"),
                        createAssistantMessage("Hi there! I can help with that. Can you please provide your order ID?"),
        ...
        List<ChatCompletionMessageToolCall> toolCalls = response.choices().get(0).message().toolCalls().get();
        ...
        assertThat(testing.logRecords())
                ...
                .anySatisfy(log -> {
                    ...
                    assertThat(log.getBodyValue())
                            .satisfies(ChatTest::assertThatValueIsEmptyMap);
                })
                .anySatisfy(log -> {
                    assertThat(log)
                            .hasAttributesSatisfying(attr -> assertThat(attr)
    ...
    void toolCallsWithCaptureMessageContent() {
        ...
        assertThat(testing.logRecords())
                ...
                .anySatisfy(log -> {
                    ...
                    assertThat(log.getBodyValue())
                            .satisfies(ValAssert.map()
                                                .entry("content", "You are a helpful customer support assistant. Use the supplied tools to assist the user.")
                            );
                })
                .anySatisfy(log -> {
                    assertThat(log)
                ...
                .anySatisfy(log -> {
                    ...
                    assertThat(log.getBodyValue())
                            .satisfies(ValAssert.map()
                                                .entry("content", "Hi there! I can help with that. Can you please provide your order ID?")
                            );
                })
                .anySatisfy(log -> {
                    assertThat(log)
                                                                           ...
                                                                           .entry("tool_calls", ValAssert.array().ignoreOrder()
                                                                                                         .entry(ValAssert.map()
                                                                                                                         ...
                                                                                                                         .entry("function", ValAssert.map()
                                                                                                                                                     ...
                                                                                                                                                     .entry("arguments", "{\"order_id\":\"order_12345\"}")
                                                                                                                         ))
                                                                           )
                                                )
                            );
    ...
    void stream() throws Exception {
        ...
        try (StreamResponse<ChatCompletionChunk> result = openai.client.chat().completions().createStreaming(params)) {
           chunks = result.stream().toList();
        }
        long durationNanos = System.nanoTime() - startTimeNanos;

        String fullMessage = chunks.stream()
    ...
    void streamToolsAndCaptureMessageContent() throws Exception {
        ...
        String fullMessage = chunks.stream()
                                        .map(cc -> cc.choices().getFirst().delta().content())
    ...
    */
    ...
    void toolsWithFollowupAndCaptureContent() {
        ...
        ChatCompletionMessageParam assistantMessage = ChatCompletionMessageParam.ofChatCompletionAssistantMessageParam(ChatCompletionAssistantMessageParam.builder()
        ...
        ChatCompletion fullCompletion = openai.client.chat().completions().create(ChatCompletionCreateParams.builder()
                .messages(chatMessages)
                .model(TEST_CHAT_MODEL)
                .build());
        ...
        ChatCompletion.Choice finalChoice = fullCompletion.choices().getFirst();
        ...
        assertThat(testing.spans())
                ...
                .satisfies(span -> {
                    assertThat(span)
                            ...
                            .hasAttribute(GEN_AI_RESPONSE_FINISH_REASONS, List.of("stop"))
                            .hasAttribute(SERVER_ADDRESS, "localhost")
                            .hasAttribute(SERVER_PORT, (long) openai.getPort());
                });
        ...
        return ChatCompletionTool.builder()
                ...
                .function(FunctionDefinition.builder()
                        ...
                        .parameters(FunctionParameters.builder()
                                ...
                                .putAdditionalProperty("properties", JsonObject.of(Map.of(
                                        "location", JsonObject.of(Map.of(
                                                "type", JsonValue.from("string"),
                                                "description", JsonValue.from("The location to get the current temperature for")
                                        ))
                                )))
                                .build())
                        .build())
    ...
    private static ChatCompletionTool buildGetDeliveryDateToolDefinition() {
        return ChatCompletionTool.builder()
                ...
                .function(FunctionDefinition.builder()
                        ...
                        .parameters(FunctionParameters.builder()
                                .putAdditionalProperty("type", JsonValue.from("object"))
                                .putAdditionalProperty("required", JsonValue.from(Collections.singletonList("order_id")))
                                .putAdditionalProperty("additionalProperties", JsonValue.from(false))
                                .putAdditionalProperty("properties", JsonObject.of(Map.of(
                                        "order_id", JsonObject.of(Map.of(
                                                "type", JsonValue.from("string"),
                                                "description", JsonValue.from("The customer's order ID.")
                                        ))
                                )))
                                .build())
                        .build())
    ...
    private static ChatCompletionMessageParam createToolMessage(String response, String id) {
        return ChatCompletionMessageParam.ofChatCompletionToolMessageParam(ChatCompletionToolMessageParam.builder()
