...
public class QueueBasedObjectPool<T> extends AbstractObjectPool<T> {
   ...
   */
  public static <T extends Recyclable> QueueBasedObjectPool<T> ofRecyclable(Queue<T> queue,
      boolean preAllocate, Allocator<T> allocator) {
    return new QueueBasedObjectPool<>(queue, preAllocate, allocator,
        Resetter.ForRecyclable.<T>get());
  }
   ...
   */
  public static <T> QueueBasedObjectPool<T> of(Queue<T> queue, boolean preAllocate,
      Allocator<? extends T> allocator, Resetter<? super T> resetter) {
    return new QueueBasedObjectPool<>(queue, preAllocate, allocator, resetter);
  }

  private QueueBasedObjectPool(Queue<T> queue, boolean preAllocate,
      Allocator<? extends T> allocator, Resetter<? super T> resetter) {
